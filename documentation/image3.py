...
def draw_main_text():
    ...
    text("Font.Garden", (0.93 * MARGIN, (6 * MARGIN) + 40))
    text("Font.Garden", (0.93 * MARGIN, (5 * MARGIN) + 40))
    text("Font.Garden", (0.93 * MARGIN, (4 * MARGIN) + 40))
    text("Font.Garden", (0.93 * MARGIN, (3 * MARGIN) + 40))
    text("Font.Garden", (0.93 * MARGIN, (2 * MARGIN) + 40))
    text("Font.Garden", (0.93 * MARGIN, (1 * MARGIN) + 40))
